    ...
    <div className="interview-wrapper">
      ...
      <div className="interview-container">
        ...
        <aside className="iv-sidebar">
          ...
          <div className="iv-sidebar__footer">
            <button
              onClick={() => {
            ...
            >
              <svg height={"0.9rem"} style={{marginRight : "0.4rem"}} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
